    ...
    for i in range(len(numberofHiddenNeuronsList)):
        for j in range(len(CList)):
            ...
            for ans in range(list(shape(Rn))[0]):
                answer[5+ans] = Rn[ans]
            array2CSV(answer, filePath, fileName)
